@StartAtHomePage
@ResetData
Feature: Create Test Requests - Lead Technician
	To manage work activities
	As a Lead Technician
...
#	And I accept the Delete alert with text "Are you SURE you wish to delete this Test Request?"